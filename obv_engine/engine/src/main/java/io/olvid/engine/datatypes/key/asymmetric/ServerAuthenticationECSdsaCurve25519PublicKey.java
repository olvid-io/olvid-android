...
public class ServerAuthenticationECSdsaCurve25519PublicKey extends ServerAuthenticationECSdsaPublicKey {
    public ServerAuthenticationECSdsaCurve25519PublicKey(HashMap<DictionaryKey, Encoded> key) {
        super(ServerAuthenticationPublicKey.ALGO_IMPL_SIGN_CHALLENGE_EC_SDSA_CURVE25519, key, new SignatureECSdsaCurve25519PublicKey(key));
    }
    ...
    public static ServerAuthenticationECSdsaCurve25519PublicKey of(byte[] compactKeyBytes) throws DecodingException {
        if ((compactKeyBytes[0] != ServerAuthenticationPublicKey.ALGO_IMPL_SIGN_CHALLENGE_EC_SDSA_CURVE25519) || (compactKeyBytes.length != COMPACT_KEY_LENGTH)){
