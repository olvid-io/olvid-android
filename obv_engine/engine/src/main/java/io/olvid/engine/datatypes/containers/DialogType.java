...
//    public static final int GROUP_JOINED_DIALOG_ID = 12;
    ...
    public static DialogType createDeleteDialog() {
        return new DialogType(DELETE_DIALOG_ID, null, null, null, null, null, null, null, null, null, null, null, null);
    }

    public static DialogType createInviteSentDialog(String contactDisplayName, Identity contactIdentity) {
        return new DialogType(INVITE_SENT_DIALOG_ID, contactDisplayName, contactIdentity, null, null, null, null, null, null, null, null, null, null);
    }
    ...
    public static DialogType createAcceptInviteDialog(String contactSerializedDetails, Identity contactIdentity, long serverTimestamp) {
        return new DialogType(ACCEPT_INVITE_DIALOG_ID, contactSerializedDetails, contactIdentity, null, null, null, null, null, null, null, serverTimestamp, null, null);
    }
    ...
    public static DialogType createSasExchangeDialog(String contactSerializedDetails, Identity contactIdentity, byte[] sasToDisplay, long serverTimestamp) {
        return new DialogType(SAS_EXCHANGE_DIALOG_ID, contactSerializedDetails, contactIdentity, sasToDisplay, null, null, null, null, null, null, serverTimestamp, null, null);
    }
    ...
    public static DialogType createSasConfirmedDialog(String contactSerializedDetails, Identity contactIdentity, byte[] sasToDisplay, byte[] sasEntered) {
        return new DialogType(SAS_CONFIRMED_DIALOG_ID, contactSerializedDetails, contactIdentity, sasToDisplay, sasEntered, null, null, null, null, null, null, null, null);
    }

    public static DialogType createInviteAcceptedDialog(String contactSerializedDetails, Identity contactIdentity) {
        return new DialogType(INVITE_ACCEPTED_DIALOG_ID, contactSerializedDetails, contactIdentity, null, null, null, null, null, null, null, null, null, null);
    }
    ...
    public static DialogType createAcceptMediatorInviteDialog(String contactSerializedDetails, Identity contactIdentity, Identity mediatorIdentity, long serverTimestamp) {
        return new DialogType(ACCEPT_MEDIATOR_INVITE_DIALOG_ID, contactSerializedDetails, contactIdentity, null, null, mediatorIdentity, null, null, null, null, serverTimestamp, null, null);
    }
    ...
    public static DialogType createMediatorInviteAcceptedDialog(String contactSerializedDetails, Identity contactIdentity, Identity mediatorIdentity) {
        return new DialogType(MEDIATOR_INVITE_ACCEPTED_DIALOG_ID, contactSerializedDetails, contactIdentity, null, null, mediatorIdentity, null, null, null, null, null, null, null);
    }
    ...
    public static DialogType createAcceptGroupInviteDialog(String serializedGroupDetails, UID groupUid, Identity groupOwnerIdentity, Identity[] pendingGroupMemberIdentities, String[]  pendingGroupMemberSerializedDetails, long serverTimestamp) {
        return new DialogType(ACCEPT_GROUP_INVITE_DIALOG_ID, null, null, null, null, groupOwnerIdentity, serializedGroupDetails, groupUid, pendingGroupMemberIdentities, pendingGroupMemberSerializedDetails, serverTimestamp, null, null);
    }

    public static DialogType createOneToOneInvitationSentDialog(Identity contactIdentity) {
        return new DialogType(ONE_TO_ONE_INVITATION_SENT_DIALOG_ID, null, contactIdentity, null, null, null, null, null, null, null, null, null, null);
    }

    public static DialogType createAcceptOneToOneInvitationDialog(Identity contactIdentity, long serverTimestamp) {
        return new DialogType(ACCEPT_ONE_TO_ONE_INVITATION_DIALOG_ID, null, contactIdentity, null, null, null, null, null, null, null, serverTimestamp, null, null);
    }

    public static DialogType createGroupV2InvitationDialog(Identity inviterIdentity, ObvGroupV2 obvGroupV2) {
        return new DialogType(ACCEPT_GROUP_V2_INVITATION_DIALOG_ID, null, null, null, null, inviterIdentity, null, null, null, null, null, obvGroupV2, null);
    }

    public static DialogType createGroupV2FrozenInvitationDialog(Identity inviterIdentity, ObvGroupV2 obvGroupV2) {
        return new DialogType(GROUP_V2_FROZEN_INVITATION_DIALOG_ID, null, null, null, null, inviterIdentity, null, null, null, null, null, obvGroupV2, null);
    }
