...
public class ObvSyncAtom {
    ...
    private ObvSyncAtom(int syncType, Identity contactIdentity, byte[] groupOwnerAndUid, byte[] bytesGroupIdentifier, String stringValue, Integer integerValue, Boolean booleanValue, List<DiscussionIdentifier> discussionIdentifiers, MessageIdentifier messageIdentifier) {
    ...
    public static ObvSyncAtom createContactNicknameChange(byte[] bytesContactIdentity, String nickname) throws DecodingException {
        return new ObvSyncAtom(TYPE_CONTACT_NICKNAME_CHANGE, Identity.of(bytesContactIdentity), null, null, nickname, null, null, null, null);
    }

    public static ObvSyncAtom createGroupV1NicknameChange(byte[] bytesGroupOwnerAndUid, String nickname) {
        return new ObvSyncAtom(TYPE_GROUP_V1_NICKNAME_CHANGE, null, bytesGroupOwnerAndUid, null, nickname, null, null, null, null);
    }

    public static ObvSyncAtom createGroupV2NicknameChange(byte[] bytesGroupV2Identifier, String nickname) {
        return new ObvSyncAtom(TYPE_GROUP_V2_NICKNAME_CHANGE, null, null, bytesGroupV2Identifier, nickname, null, null, null, null);
    }
    ...
    public static ObvSyncAtom createContactPersonalNoteChange(byte[] bytesContactIdentity, String personalNote) throws DecodingException {
        return new ObvSyncAtom(TYPE_CONTACT_PERSONAL_NOTE_CHANGE, Identity.of(bytesContactIdentity), null, null, personalNote, null, null, null, null);
    }

    public static ObvSyncAtom createGroupV1PersonalNoteChange(byte[] bytesGroupOwnerAndUid, String nickname) {
        return new ObvSyncAtom(TYPE_GROUP_V1_PERSONAL_NOTE_CHANGE, null, bytesGroupOwnerAndUid, null, nickname, null, null, null, null);
    }

    public static ObvSyncAtom createGroupV2PersonalNoteChange(byte[] bytesGroupV2Identifier, String nickname) {
        return new ObvSyncAtom(TYPE_GROUP_V2_PERSONAL_NOTE_CHANGE, null, null, bytesGroupV2Identifier, nickname, null, null, null, null);
    }

    public static ObvSyncAtom createOwnProfileNicknameChange(String nickname) {
        return new ObvSyncAtom(TYPE_OWN_PROFILE_NICKNAME_CHANGE, null, null, null, nickname, null, null, null, null);
    }
    ...
    public static ObvSyncAtom createContactCustomHueChange(byte[] bytesContactIdentity, Integer customHue) throws DecodingException {
        return new ObvSyncAtom(TYPE_CONTACT_CUSTOM_HUE_CHANGE, Identity.of(bytesContactIdentity), null, null, null, customHue, null, null, null);
    }
    ...
    public static ObvSyncAtom createContactSendReadReceiptChange(byte[] bytesContactIdentity, Boolean sendReadReceipt) throws DecodingException {
        return new ObvSyncAtom(TYPE_CONTACT_SEND_READ_RECEIPT_CHANGE, Identity.of(bytesContactIdentity), null, null, null, null, sendReadReceipt, null, null);
    }

    public static ObvSyncAtom createGroupV1SendReadReceiptChange(byte[] bytesGroupOwnerAndUid, Boolean sendReadReceipt) {
        return new ObvSyncAtom(TYPE_GROUP_V1_SEND_READ_RECEIPT_CHANGE, null, bytesGroupOwnerAndUid, null, null, null, sendReadReceipt, null, null);
    }

    public static ObvSyncAtom createGroupV2SendReadReceiptChange(byte[] bytesGroupV2Identifier, Boolean sendReadReceipt) {
        return new ObvSyncAtom(TYPE_GROUP_V2_SEND_READ_RECEIPT_CHANGE, null, null, bytesGroupV2Identifier, null, null, sendReadReceipt, null, null);
    }

    public static ObvSyncAtom createPinnedDiscussionsChange(List<DiscussionIdentifier> discussionIdentifiers, boolean ordered) {
        return new ObvSyncAtom(TYPE_PINNED_DISCUSSIONS_CHANGE, null, null, null, null, null, ordered, discussionIdentifiers, null);
    }
    ...
    public static ObvSyncAtom createTrustContactDetails(Identity contactIdentity, String serializedIdentityDetailsWithVersionAndPhoto) {
        return new ObvSyncAtom(TYPE_TRUST_CONTACT_DETAILS, contactIdentity, null, null, serializedIdentityDetailsWithVersionAndPhoto, null, null, null, null);
    }
    ...
    public static ObvSyncAtom createTrustGroupV1Details(byte[] bytesGroupOwnerAndUid, String serializedGroupDetailsWithVersionAndPhoto) {
        return new ObvSyncAtom(TYPE_TRUST_GROUP_V1_DETAILS, null, bytesGroupOwnerAndUid, null, serializedGroupDetailsWithVersionAndPhoto, null, null, null, null);
    }

    public static ObvSyncAtom createTrustGroupV2Details(GroupV2.Identifier groupIdentifier, int version) {
        return new ObvSyncAtom(TYPE_TRUST_GROUP_V2_DETAILS, null, null, groupIdentifier.encode().getBytes(), null, version, null, null, null);
    }

    public static ObvSyncAtom createSettingDefaultSendReadReceipts(boolean sendReadReceipt) {
        return new ObvSyncAtom(TYPE_SETTING_DEFAULT_SEND_READ_RECEIPTS, null, null, null, null, null, sendReadReceipt, null, null);
    }

    public static ObvSyncAtom createSettingAutoJoinGroups(String autoJoinGroupsType) {
        return new ObvSyncAtom(TYPE_SETTING_AUTO_JOIN_GROUPS, null, null, null, autoJoinGroupsType, null, null, null, null);
    }

    public static ObvSyncAtom createBookmarkedMessageChange(MessageIdentifier messageIdentifier, boolean bookmarked) {
        return new ObvSyncAtom(TYPE_BOOKMARKED_MESSAGE_CHANGE, null, null, null, null, null, bookmarked, null, messageIdentifier);
    }
        ...
        switch (syncType) {
            ...
            case TYPE_CONTACT_PERSONAL_NOTE_CHANGE: {
                if (encodeds.length == 2) {
                    return new ObvSyncAtom(syncType, encodeds[1].decodeIdentity(), null, null, null, null, null, null, null);
                } else if (encodeds.length == 3) {
                    return new ObvSyncAtom(syncType, encodeds[1].decodeIdentity(), null, null, encodeds[2].decodeString(), null, null, null, null);
                }
                break;
            }
            case TYPE_GROUP_V1_NICKNAME_CHANGE:
            case TYPE_GROUP_V1_PERSONAL_NOTE_CHANGE: {
                if (encodeds.length == 3) {
                    return new ObvSyncAtom(syncType, null, joinArrays(encodeds[1].decodeBytes(), encodeds[2].decodeBytes()), null, null, null, null, null, null);
                } else if (encodeds.length == 4) {
                    return new ObvSyncAtom(syncType, null, joinArrays(encodeds[1].decodeBytes(), encodeds[2].decodeBytes()), null, encodeds[3].decodeString(), null, null, null, null);
                }
                break;
            }
            case TYPE_GROUP_V2_NICKNAME_CHANGE:
            case TYPE_GROUP_V2_PERSONAL_NOTE_CHANGE: {
                if (encodeds.length == 2) {
                    return new ObvSyncAtom(syncType, null, null, encodeds[1].decodeBytes(), null, null, null, null, null);
                } else if (encodeds.length == 3) {
                    return new ObvSyncAtom(syncType, null, null, encodeds[1].decodeBytes(), encodeds[2].decodeString(), null, null, null, null);
                }
                break;
            }
            case TYPE_OWN_PROFILE_NICKNAME_CHANGE: {
                if (encodeds.length == 1) {
                    return new ObvSyncAtom(syncType, null, null, null, null, null, null, null, null);
                } else if (encodeds.length == 2) {
                    return new ObvSyncAtom(syncType, null, null, null, encodeds[1].decodeString(), null, null, null, null);
                }
                break;
            }
            case TYPE_CONTACT_CUSTOM_HUE_CHANGE: {
                if (encodeds.length == 2) {
                    ...
                    return new ObvSyncAtom(syncType, encodeds[1].decodeIdentity(), null, null, null, (int) encodeds[2].decodeLong(), null, null, null);
                }
                break;
            }
            case TYPE_CONTACT_SEND_READ_RECEIPT_CHANGE: {
                if (encodeds.length == 2) {
                    ...
                    return new ObvSyncAtom(syncType, encodeds[1].decodeIdentity(), null, null, null, null, encodeds[2].decodeBoolean(), null, null);
                }
                break;
            }
            case TYPE_GROUP_V1_SEND_READ_RECEIPT_CHANGE: {
                if (encodeds.length == 3) {
                    ...
                    return new ObvSyncAtom(syncType, null, joinArrays(encodeds[1].decodeBytes(), encodeds[2].decodeBytes()), null, null, null, encodeds[3].decodeBoolean(), null, null);
                }
                break;
            }
            case TYPE_GROUP_V2_SEND_READ_RECEIPT_CHANGE: {
                if (encodeds.length == 2) {
                    ...
                    return new ObvSyncAtom(syncType, null, null, encodeds[1].decodeBytes(), null, null, encodeds[2].decodeBoolean(), null, null);
                }
                break;
            }
            case TYPE_BOOKMARKED_MESSAGE_CHANGE: {
                return new ObvSyncAtom(syncType, null, null, null, null, null, encodeds[2].decodeBoolean(), null, MessageIdentifier.of(encodeds[1]));
            }
            case TYPE_PINNED_DISCUSSIONS_CHANGE: {
                ...
                return new ObvSyncAtom(syncType, null, null, null, null, null, encodeds[2].decodeBoolean(), discussionIdentifiers, null);
            }
            case TYPE_TRUST_CONTACT_DETAILS: {
                return new ObvSyncAtom(syncType, encodeds[1].decodeIdentity(), null, null, encodeds[2].decodeString(), null, null, null, null);
            }
            ...
            case TYPE_TRUST_GROUP_V2_DETAILS: {
                return new ObvSyncAtom(syncType, null, null, encodeds[1].decodeBytes(), null, (int) encodeds[2].decodeLong(), null, null, null);
            }
            case TYPE_SETTING_DEFAULT_SEND_READ_RECEIPTS: {
                return new ObvSyncAtom(syncType, null, null, null, null, null, encodeds[1].decodeBoolean(), null, null);
            }
            case TYPE_SETTING_AUTO_JOIN_GROUPS: {
                return new ObvSyncAtom(syncType, null, null, null, encodeds[1].decodeString(), null, null, null, null);
            }
    ...
    public static class MessageIdentifier {
        ...
        public Encoded encode() {
            ...
            encodeds.add(discussionIdentifier.encode());
            encodeds.add(Encoded.of(senderIdentifier));
            encodeds.add(Encoded.of(senderThreadIdentifier));
            encodeds.add(Encoded.of(senderSequenceNumber));
            return Encoded.of(encodeds.toArray(new Encoded[0]));
        }
