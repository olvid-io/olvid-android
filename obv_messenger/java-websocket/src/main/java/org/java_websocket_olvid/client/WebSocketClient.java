...
import org.java_websocket_olvid.AbstractWebSocket;
...
public abstract class WebSocketClient extends AbstractWebSocket implements Runnable, WebSocket {
   ...
   */
  // Here is the only patch ... we need to access engine.outBuf to know if connection is over loaded or not
  protected WebSocketImpl engine = null;
