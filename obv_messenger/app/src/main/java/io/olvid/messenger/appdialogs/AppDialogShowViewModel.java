...
public class AppDialogShowViewModel extends ViewModel {
    ...
    public AppDialogTag getCurrentlyShowingDialogTag() {
        return currentlyShowingDialogTag;
    }

    public void setCurrentlyShowingDialogTag(AppDialogTag currentlyShowingDialogTag) {
        this.currentlyShowingDialogTag = currentlyShowingDialogTag;
    }
}
