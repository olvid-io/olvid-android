...
public abstract class AbstractSendLocationFragment extends DialogFragment {
    ...
    abstract void checkPermissionsAndUpdateDialog();
        ...
        grantLocationPermissionActivityResultLauncher = registerForActivityResult(new ActivityResultContracts.RequestMultiplePermissions(), result -> {
            ...
            if ((fineLocationGranted == null || !fineLocationGranted)
                ...
                new SecureAlertDialogBuilder(context, R.style.CustomAlertDialog)
                        ...
                        .setNegativeButton(R.string.button_label_cancel, (DialogInterface dialogInterface, int i) -> this.dismiss())
                        .setOnCancelListener(dialogInterface -> this.dismiss())
                        .create()
                        .show();
                return;
            }
    ...
    protected boolean isLocationPermissionGranted(FragmentActivity activity) {
    ...
    protected boolean isBackgroundLocationPermissionGranted(Activity activity) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
    ...
    protected void requestBackgroundLocationPermission(FragmentActivity activity) {
    ...
    protected static boolean isLocationEnabled() {
    ...
    protected void requestLocationActivation(FragmentActivity activity) {
        ...
        new SecureAlertDialogBuilder(activity, R.style.CustomAlertDialog)
                .setTitle(R.string.title_enable_location)
                .setMessage(R.string.label_enable_location)
                .setPositiveButton(R.string.button_label_open_settings, (DialogInterface dialogInterface, int i) -> {
                    App.prepareForStartActivityForResult(activity);
                    this.startActivity(openLocationSettingsIntent);
                })
                .setNegativeButton(R.string.button_label_cancel, (DialogInterface dialogInterface, int i) -> this.dismiss())
                .setOnCancelListener((dialogInterface -> this.dismiss()))
                .create().show();
