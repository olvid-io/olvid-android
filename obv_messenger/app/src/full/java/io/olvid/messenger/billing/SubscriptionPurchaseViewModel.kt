...
class SubscriptionPurchaseViewModel : ViewModel() {
    var bytesOwnedIdentity: ByteArray? by mutableStateOf(null)
        private set

    var showSubscriptionPlans by mutableStateOf(false)

    var freeTrialResults: Boolean? by mutableStateOf(null)
    var freeTrialFailed by mutableStateOf(false)
    var subscriptionDetails by mutableStateOf<List<ProductDetails>?>(null)
    var subscriptionFailed by mutableStateOf(false)
